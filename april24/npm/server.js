// Create error checking in your server. Make sure that endpoints that take client information are receiving the correct type and data. Return appropriate response error codes for each incorrect request. Check for every case where a hacker could compromise your server. Do not allow bodies in GET requests, do not allow non-authorized parameters, do not allow the wrong type for a parameter to be passed.
...
app.post('/todo', function(req, res){
    ...
    if(Object.keys(req.query).length > 0) {
        ...
        // checks each item for special characters
...
// Extra code hidden for Patch and singular GET
...
// // updates a single task in the to do list
// app.put('/todo/:id', (req, res) => {
//     console.log(req.body.completed, "this is the put request completed state");
...
//         });
//     } 
//     // else if(Object.keys(req.body).length != 0 && (typeof(req.body.completed) != 'boolean' || req.body.todo == undefined)) {
//     //     clientError(req, "Body does not meet requirements", 400);
//     //     res.status(400).json({
//     //         error: "Body does not meet requirements. You need both todo and compeleted status"
//     //     })
//     // }
...
//             clientError(req, "Body does not meet requirements", 400);
//             res.status(400).json({
//                 error: "Body does not meet requirements needs a boolean value"
//             })
//         } else if (req.body.todo != "string"){
//             clientError(req, "Body does not meet requirements", 400);
//             res.status(400).json({
//                 error: "Body does not meet requirements needs a string value"
//             })
//         }

//         // else if(req.body.todo != undefined && req.body.completed != "true") {
//         //     clientError(req, "Body does not meet requirements", 400);
//         //     res.status(400).json({
//         //         error: "Body does not meet requirements"
//         //     })
