...
// let temp = nbaTeams[0][1].split(" ");
// console.log(nbaTeams[5][3].split(" ")[1][0] == 'A');
// console.log(nbaTeams[5][3])
// console.log(temp[1]);

for(let i = 0; i < nbaTeams.length; i++) {
    for(let j = 0; j < nbaTeams[i].length; j++) {
        let firstAndLast = nbaTeams[i][j].split(" ");
        if(firstAndLast[1][0] == 'A') {
        // if(nbaTeams[i][j].split(" ")[1][0] == 'A') {
            console.log(nbaTeams[i][j])
        }
    }
}